...
export async function generateMockTestSession({
  ...
  if (questionsRaw.length === 0) {
    if (testType === 'UNIT_TEST') {
      ...
      testTitle = 'Saurashtra University LL.B. Semester 3 Grand Mock Exam';
      testSubtitle = 'Comprehensive semester simulation across Constitutional Law, Labour Law, Property Law, and Cyber Law.';
      ...
      testSubtitle = 'High-frequency exam questions based on Saurashtra University past examination papers.';
